...
def update_config():
    ...
    try:
        ...
        if active_tab == 'style' and 'background_image' in request.files:
            ...
            if file and file.filename and allowed_file(file.filename):
                ...
                set_config('background_image', f'uploads/{filename}', description='Achtergrondafbeelding', category='appearance')
...
def register_and_pay():
    ...
    allergies_notes = data.get('allergiesNotes', '').strip()
    bbq_details = get_cached_bbq_details()
    total_amount = persons_adults * bbq_details["price_per_adult"]
